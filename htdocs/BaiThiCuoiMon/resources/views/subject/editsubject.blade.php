  ...
  <div class="container py-5">
    ...
    <div class="row mb-4">
        <div class="col-lg-8 mx-auto text-center">
            <h1 class="display-6">Edit subject</h1>
        </div>
    </div> <!-- End -->
    <div class="row">
                ...
                <div class="card-header">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                            <form method="POST" action="/updatesubject/{{ $student[0]->ID_monhoc }}" role="form" >
                                @csrf
                                <div class="form-group"> <label for="ID_student">
                                        <h6>ID_monhoc</h6>
                                    </label> <input type="text" name="ID_monhoc" placeholder="Enter ID_monhoc.." class="form-control " value="{{ $student[0]->ID_monhoc }}"> </div>
                                    <div class="form-group"> <label for="First_name">
                                      <h6>Ten_monhoc</h6>
                                  </label> <input type="text" name="Ten_monhoc" placeholder="Enter First_name" class="form-control " value="{{ $student[0]->Ten_monhoc }}"> </div>

  ...
  <div class="container-scroller">
    ...
    <div class="row mb-4">
        <div class="col-lg-8 mx-auto text-center">
            <h1 class="display-6">Add teacher</h1>
        </div>
    </div> <!-- End -->
    <div class="row">
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                            <form method="POST" action="/addteacher" role="form" >
                                ...
                                <div class="form-group"> <label for="ID_teacher">
                                        <h6>ID_teacher</h6>
                                    </label> <input type="text" name="ID_teacher" placeholder="Enter ID_student" class="form-control "> </div>
                                    <div class="form-group"> <label for="First_name">
                                      <h6>Name_teacher</h6>
                                  </label> <input type="text" name="Name_teacher" placeholder="Enter First_name" class="form-control "> </div>
                            ...
                            <option value="{{ $row->id}}">-Student:{{ $row->id_student }}</option>
                            @endforeach
                          </select> </div> 

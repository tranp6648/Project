        ...
        <div class="table-wrapper">
			...
			<div class="form-outline mb-4">
				...
				<div class="input-group ps-5">
					...
					<button type="submit" class="btn btn-primary class	" style="    width: 61px; height: 45px;">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/addteacher" class="btn btn-primary  active" role="button" aria-pressed="true">ADD</a>   </td>
                        <td>
                            
                            <a href="{{ url('editteacher/'.$row->ID_teacher) }}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="{{ url('deleteteacher/'.$row->ID_teacher) }}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>

  ...
  <div class="container-scroller">
    ...
    <div class="row mb-4">
        <div class="col-lg-8 mx-auto text-center">
            <h1 class="display-6">Edit teacher</h1>
        </div>
    </div> <!-- End -->
    <div class="row">
                ...
                <div class="card-header">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                            <form method="POST" action="/updateeacher/{{$student[0]->ID_teacher  }}" role="form" >
                                @csrf
                                <div class="form-group"> <label for="ID_teacher">
                                        <h6>ID_teacher</h6>
                                    </label> <input type="text" name="ID_teacher" placeholder="Enter ID_student" class="form-control " value="{{ $student[0]->ID_teacher  }}"> </div>
                                    <div class="form-group"> <label for="First_name">
                                      <h6>Name_teacher</h6>
                                  </label> <input type="text" name="Name_teacher" placeholder="Enter First_name" class="form-control " value="{{ $student[0]->Name_teacher }}"> </div>
                                  <div class="form-group"> <label for="ID_Class">
                                    <h6>Name Class</h6>
                                </label> <select class="form-control" id="ccmonth" name="ID_Class" >
                              ...
                              <div class="form-group"> <label for="ID_feeback">
                                <h6>ID_feeback</h6>
                            </label> <select class="form-control" id="ccmonth" name="ID_feeback" >
                              
                              <option value="" selected disabled>--Please select your Bank--</option>
                            @foreach($data1 as $row)
                            <option value="{{ $row->id}}">-Student:{{ $row->id}} {{ $row->id_student }}</option>
                            @endforeach
                          </select> </div> 

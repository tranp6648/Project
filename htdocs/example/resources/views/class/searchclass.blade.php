            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/addlop" class="btn btn-primary  active" role="button" aria-pressed="true">ADD</a>   </td>
                        <td>
                            
							<a href="{{ url('editclass/'.$row->ID_class) }}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="{{ url('deletelop/'.$row->ID_class) }}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>

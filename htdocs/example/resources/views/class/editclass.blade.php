  ...
  <div class="container-scroller">
    ...
    <div class="row mb-4">
        <div class="col-lg-8 mx-auto text-center">
            <h1 class="display-6">Edit class</h1>
        </div>
    </div> <!-- End -->
    <div class="row">
                ...
                <div class="card-header">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                            <form method="POST" action="/updateclass/{{ $student[0]->ID_class }}" role="form" >
                                @csrf

                                    <div class="form-group"> <label for="name_class">
                                      <h6>name_class</h6>
                                  </label> <input type="text" name="name_class" placeholder="Enter name_class" class="form-control " value="{{ $student[0]->name_class }}"> </div>

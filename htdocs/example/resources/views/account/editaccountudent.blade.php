...
<head>
  ...
  <title>Edit Account student</title>
  <!-- plugins:css -->
 <!-- plugins:css -->
                ...
                <div class="card-header">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                            <form method="POST" action="/updateaccountstudent/{{ $student[0]->ID }}" role="form" >
                                @csrf

                                    <div class="form-group"> <label for="Username">
                                      <h6>Username</h6>
                                  </label> <input type="text" name="Username" placeholder="Enter name_class" class="form-control " value="{{ $student[0]->Username }}"> </div>
                                  <div class="form-group"> <label for="Password">
                                    <h6>Password</h6>
                                </label> <input type="password" name="Password" placeholder="Enter name_class" class="form-control " value="{{ $student[0]->Password }}"> </div>
                                <div class="form-group"> <label for="tensinhvien">
                                    <h6>Ten sinh vien</h6>
                                </label> <select class="form-control" id="ccmonth" name="drop" value="{{ $student[0]->Id_student }}">
                                  
                                  <option value="" selected disabled>--Please select name sinh vien--</option>
                                  @foreach($data as $row)
                                  <option value="{{ $row->Id_student }}">Ten sv:{{ $row->First_name }} {{ $row->Last_name }}</option>
                               @endforeach
                              </select> </div> 

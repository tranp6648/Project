...
<title>Manager Account teacher</title>
	  ...
	  <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Manage <b>Account teacher</b></h2>
					</div>
					
                </div>
            </div>
			<div class="form-outline mb-4">
				<form action="/searchaccoutteacher" method="GET">
					
				<div class="input-group ps-5">
					<div id="navbar-search-autocomplete" class="form-outline">
					  <input type="search" id="form1" class="form-control"  name="query" id="query" />
					  <label class="form-label" for="form1">Search</label>
					</div>
					<button type="submit" class="btn btn-primary class	" style="    width: 61px;
    height: 45px;">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/addaccounteacher" class="btn btn-primary  active" role="button" aria-pressed="true">ADD</a>   </td>
                        <td>
                            
                            <a href="{{ url('editaccounteacher/'.$row->ID) }}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="{{ url('deleteaccounteacher/'.$row->ID) }}"class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>

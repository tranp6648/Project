	  ...
	  <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Manage <b>Account student</b></h2>
					</div>
					
                </div>
            </div>
			<div class="form-outline mb-4">
				<form action="/searchaccoutstudent" method="GET">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{  $row->Email}}</td>
                        <td>{{  $row->tel}}</td>
                        <td><a href="/addaccountstudent" class="btn btn-primary  active" role="button" aria-pressed="true">ADD</a>   </td>
                        <td>
                            
							<a href="{{ url('editaccountudent/'.$row->ID) }}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href=" {{ url('deleteaccoutstudent/'.$row->ID) }}  "class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>

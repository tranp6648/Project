            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/addsubject" class="btn btn-primary  active" role="button" aria-pressed="true">ADD</a>   </td>
                        <td>
                            
                            <a href="{{ url('editsubject/'.$row->ID_monhoc) }}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="{{ url('deletesubject/'.$row->ID_monhoc) }}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>

...
<title>Manager feeback appoved</title>
	  ...
	  <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Manage <b>feedback approved</b></h2>
					</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
							...
							<a class="btn btn-success" href="{{ url('approved',$row->id) }}">Approved</a>
                        ...
                        <td>
                          ...
                          <a class="btn btn-danger" href="{{ url('canceled',$row->id) }}">Canceled

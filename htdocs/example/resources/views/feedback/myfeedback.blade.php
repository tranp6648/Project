    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/myfeedback">
              <i class="ti-pencil-alt menu-icon"></i>
	  ...
	  <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Manage <b>myfeedback</b></h2>
					</div>
					
                </div>
            </div>
			<div class="form-outline mb-4">
				<form action="/searchmyfeedback" method="GET">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
					...
					<td>{{ $row->id }}</td>
						...
						<td>
						<a href="{{ url('deletetemyfeedback/'.$row->id ) }}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>

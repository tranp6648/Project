                ...
                <div class="col-md-6 col-xl-4" style="width: 16vw">
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            @csrf
                                <div class="mb-3"><input class="form-control" type="name" name="usrname" placeholder="Email" require />
         
                          
                                </div>
                                <div class="mb-3"><input class="form-control" type="password" name="password" placeholder="Password" require />
